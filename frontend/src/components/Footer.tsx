    ...
    <footer className="bg-white border-t">
      <div className="container mx-auto px-4 py-2">
        <nav className="flex justify-between items-center">
          ...
          <Link to="/trade" className="flex flex-col items-center text-gray-600 hover:text-blue-600">
            <BarChart2 className="w-6 h-6" />
            <span className="text-xs mt-1">取引</span>
          </Link>
          <Link to="/deposit-withdraw" className="flex flex-col items-center text-gray-600 hover:text-blue-600">
